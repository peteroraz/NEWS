...
export const SportsIcon = Trophy;
export const EntertainmentIcon = Film;
export const BusinessIcon = Briefcase;
export const PoliticsIcon = Landmark;
export const ReligionIcon = Church;
export const FashionIcon = Shirt;
export const TechIcon = Cpu;
export const HealthIcon = Stethoscope;
export const EducationIcon = GraduationCap;
export const InvestorsIcon = Wallet;
export const LifestyleIcon = Palmtree;

export const DefaultIcon = Newspaper;
...
// Social Media Icons
export const XIcon = Twitter; // Using Twitter icon for X
export const InstagramIcon = Instagram;
export const FacebookIcon = Facebook;

// WhatsApp is not in Lucide, so we keep the custom one or use a generic message icon
...
export const getIconForCategory = (category: string): React.ElementType => {
  return categoryIcons[category.toLowerCase()] || DefaultIcon;
};
